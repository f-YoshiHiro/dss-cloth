...
public:
    ...
    virtual ScalarType  EvaluatePotentialEnergy(const EigenVectorXs& x) {std::cout << "Warning: reach <Constraint> base class virtual function." << std::endl; return 0;}
    virtual void  EvaluateGradient(const EigenVectorXs& x, EigenVectorXs& gradient) {std::cout << "Warning: reach <Constraint> base class virtual function." << std::endl;}
    virtual void  EvaluateHessian(const EigenVectorXs& x, std::vector<SparseMatrixTriplet>& hessian_triplets) {std::cout << "Warning: reach <Constraint> base class virtual function." << std::endl;}
    ...
    virtual void EvaluateDVector(unsigned int index, const EigenVectorXs& x, EigenVectorXs& d){std::cout << "Warning: reach <Constraint> base class virtual function." << std::endl;}
...
public:
    ...
    virtual ScalarType  EvaluatePotentialEnergy(const EigenVectorXs& x);
    virtual void  EvaluateGradient(const EigenVectorXs& x, EigenVectorXs& gradient);
    virtual void  EvaluateHessian(const EigenVectorXs& x, std::vector<SparseMatrixTriplet>& hessian_triplets);
    ...
    // for local global method
    virtual void EvaluateDVector(unsigned int index, const EigenVectorXs& x, EigenVectorXs& d);
