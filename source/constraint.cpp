...
ScalarType AttachmentConstraint::EvaluatePotentialEnergy(const EigenVectorXs& x)
{
...
void AttachmentConstraint::EvaluateGradient(const EigenVectorXs& x, EigenVectorXs& gradient)
{
    EigenVector3 g_i = (*(m_stiffness))*(x.block_vector(m_p0) - m_fixd_point);
    gradient.block_vector(m_p0) += g_i;
}

void AttachmentConstraint::EvaluateHessian(const EigenVectorXs& x, std::vector<SparseMatrixTriplet>& hessian_triplets)
{
...
void AttachmentConstraint::EvaluateDVector(unsigned int index, const EigenVectorXs& x, EigenVectorXs& d)
{
...
ScalarType SpringConstraint::EvaluatePotentialEnergy(const EigenVectorXs& x)
{
...
void SpringConstraint::EvaluateGradient(const EigenVectorXs& x, EigenVectorXs& gradient)
{
    EigenVector3 x_ij = x.block_vector(m_p1) - x.block_vector(m_p2);
...
void SpringConstraint::EvaluateHessian(const EigenVectorXs& x, std::vector<SparseMatrixTriplet>& hessian_triplets)
{
    EigenVector3 x_ij = x.block_vector(m_p1) - x.block_vector(m_p2);
...
void SpringConstraint::EvaluateDVector(unsigned int index, const EigenVectorXs& x, EigenVectorXs& d)
{
    EigenVector3 x_ij = x.block_vector(m_p1) - x.block_vector(m_p2);
